        ...
        <form id="couponForm">
            <div class="d-md-flex d-block align-items-center justify-content-between mb-3">
                <div class="my-auto mb-2">
                    <h3 class="page-title mb-1">{{ __('Edit Coupon') }}</h3>
                    <nav>
                ...
                <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
                    <div class="mb-2">
                    <button type="submit" class="btn btn-primary" id="save_coupon_btn" data-save="{{ __('Save') }}">{{ __('Save') }}</button>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="mb-3">
                                                ...
                                                <select class=" form-control select" id="product_type" name="product_type" data-placeholder="{{ __('select_product_type') }}">
                                        ...
                                        <div class="col-6 {{ ($data->product_type != 'all' && $data->product_type == 'category') ? '' : 'd-none'}}" id="category_field">
                                            <div class="mb-3">
                                                <label class="form-label">{{ __('Category') }}<span class="text-danger"> *</span></label>
                                                <select class="form-control custom-select2" id="category_id" name="category_id[]" data-placeholder="{{ __('select_category') }}" multiple>
                                                    @if ($categories)
                                        ...
                                        <div class="col-6 {{ ($data->product_type != 'all' && $data->product_type == 'subcategory') ? '' : 'd-none'}}" id="subcategory_field">
                                            <div class="mb-3">
                                                <label class="form-label">{{ __('Sub Category') }}<span class="text-danger"> *</span></label>
                                                <select class="form-control custom-select2" id="subcategory_id" name="subcategory_id[]" data-placeholder="{{ __('select_sub_category') }}" multiple>
                                                    @if ($subcategories)
                                        ...
                                        <div class="col-6 {{ ($data->product_type != 'all' && $data->product_type == 'service') ? '' : 'd-none'}}" id="product_field">
                                            <div class="mb-3">
                                                <label class="form-label">{{ __('Service') }}<span class="text-danger"> *</span></label>
                                                <select class="form-control custom-select2" id="product_id" name="product_id[]" data-placeholder="{{ __('select_product') }}" multiple>
                                                    @if ($products)
                                        ...
                                        <div class="col-6">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-control select" id="coupon_type" name="coupon_type" data-placeholder="{{ __('select_coupon_type') }}">
                                        ...
                                        <div class="col-6">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-control select" id="quantity" name="quantity" data-placeholder="{{ __('select_quantity') }}">
                                        ...
                                        <div class="col-6 {{ $data->quantity == 'limited' ? '' : 'd-none' }}" id="quantity_value_field">
                                            <div class="mb-3">
